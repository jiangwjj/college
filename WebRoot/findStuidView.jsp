      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:50px;">老师信息</td></tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:60px;">
                  ...
                  <tr>
                    <td height="60" align="right"><span style="color:red;"></span>id:</td>
                    <td>${teacher.teaid}></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>${teacher.teagender=="1"?"男":"女"}</td>
                    </tr>
                    <tr>
                    <td height="60" align="right"><span style="color:red;"></span>电子邮件：</td>
                      <td>${teacher.email}</td>
                      </tr>
                      <tr>
                      <td height="60" align="right"><span style="color:red;"></span>电话号码：</td>
                      <td>${teacher.phone}</td>
