      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">学生管理&nbsp;<br></td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                <form name="form1" method="post" action="<%=basePath%>test/Student_findStudentByClassAndCourseName.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
               
                  <tr>
                 
                    <td width="40%" height="30" style="padding-left:20px;">
                     功能导航： 班级  <select name="stu" >
                ...
                <c:forEach items="${list}" var="list">
                    <tr align="center">
                      ...
                      <td align="center"><a href="<%=basePath%>test/Student_teacherUpdateStudentByidView.action?stuid=${list.stuid}">修改</a></td>
                    </tr>
                    </c:forEach>
