      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="<%=basePath %>test/Student_uppdateStudent.action?stuid=${stuid}" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>迟到：</td>
                    <td><input name="stugender" type="text" class="text2" value="${late}"></td>
                  </tr>
                    <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>旷课：</td>
                    <td><input name="stugender" type="text" class="text2" value="${stuout}"></td>
                  </tr>
               </tr>
                    <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>日期：</td>
                    <td> <input id="studate" name="studate" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" /><br><br>  
                    </td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
