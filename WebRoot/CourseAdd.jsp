...
function mycheck(){
if(isNull(form1.courseid.value)){  
   alert("请输入课程号"); 
   return false;
   }
   if(isNull(form1.coursename.value)){  
   alert("请输入课程名称！"); 
   return false;
   } 
}
      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="<%=basePath %>test/Course_addCourse.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="courseid" type="text" class="text2" ></td>
                  </tr>
                  <tr>
