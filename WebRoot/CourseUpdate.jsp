      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action=" <%=basePath %>test/Course_updateCourse.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="courseid" value="${course.courseid}" type="text" class="text2" ></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>课程名称：</td>
                    <td><input name="coursename"  value="${course.coursename}" type="text" class="text2" ></td>
                  </tr>
