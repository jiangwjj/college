      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="<%=basePath %>test/Student_updatefindStudentbyId.action?stuid=${student.stuid}" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                   ...
                   <td><input value="${student.stuname}" name="stuname" type="text"/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>性别：</td>
             
              <td>    男 <input type="radio" checked="checked" name="teagender" value="1" />
                                                                        女 <input type="radio" name="teagender" value="0" />
                  </td></tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>班级：</td>
                    <td><input value="${student.stuclass=="1"?"13级软件1班":"13级软件2班"}" name="stuclass" type="text"/></td>
                  </tr>
